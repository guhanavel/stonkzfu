from sidefun import read_csv, lookup, gen, su, summary, earnings, news_api, load_data
import dash
...
NASQ = read_csv(r"constituents_csv.csv")
opt = lookup(NASQ)
    ...
    dbc.Container(
        [
            html.A(
                ...
                dbc.Row(
                    [
                        dbc.Col(html.Img(src="stonkzfublack.png")),
